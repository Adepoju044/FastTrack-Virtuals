...
const Founder = () => {
  return (
    <>
      <SEO
        title="Our Founder - FastTrack Virtuals"
        description="Meet Emil Nabor Ekiyor, the founder of FastTrack Virtuals. Learn how he's bridging the gap between African talent and global business opportunities."
        url="https://fasttrackvirtual.com/founder"
      />
      <Header />

      <section className="bg-gradient-to-br from-ftvprimary-100 via-ftvprimary-200 to-ftvprimary-300 dark:from-gray-800 dark:via-gray-900 dark:to-gray-950 pt-32 pb-16 text-center px-4">
      ...
      <section className="bg-ftvoffwhite dark:bg-gray-950 py-16 sm:py-20 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 items-start">
          <div className="md:w-5/12 w-full flex justify-center">
            <div className="w-full max-w-xs sm:max-w-sm">
              <div className="w-full rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="/emil.jpg"
                  alt="Emil Nabor Ekiyor — Founder of FastTrack Virtuals"
                  className="w-full h-auto object-cover object-top"
                />
              </div>
              <div className="mt-4 bg-gradient-to-r from-ftvsecondary to-ftvprimary text-white px-5 py-3 rounded-xl shadow-lg text-center">
                <p className="font-bold text-base sm:text-lg">
                  Emil Nabor Ekiyor
                </p>
                <p className="text-sm text-white/80 plusjakartasans">
                  Founder, FastTrack Virtual
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-7/12 w-full space-y-5">
            ...
            <p className="text-ftvgrey dark:text-gray-300 plusjakartasans leading-relaxed text-sm sm:text-base">
              Emil saw this disconnect and decided to bridge it. Fast Track
              Virtual is his solution — a platform built to connect African
              talent directly with international clients, removing the usual
              barriers of access, trust, and visibility.
            </p>
            <p className="text-ftvgrey dark:text-gray-300 plusjakartasans leading-relaxed text-sm sm:text-base">
            ...
            <blockquote className="border-l-4 border-ftvprimary pl-5 py-2">
              <p className="text-ftvblack dark:text-white font-medium text-base sm:text-lg italic plusjakartasans">
                &ldquo;Through Fast Track Virtual, Emil is building more than a
                service — he&apos;s creating a pathway for African professionals
                to earn globally, grow confidently, and compete at the highest
                level.&rdquo;
              </p>
            </blockquote>
          </div>
